...
/**
 * Optional world-resolution scale for 26.2.
 * Swap GameRenderer.mainRenderTarget to a scaled MainTarget for renderLevel,
 * blit back, HUD stays native. Similar idea to the RenderScale mod; this
 * code is separate. Off when that mod is loaded.
 */
