...
import hsn.optimizations.client.compat.HSNClothCompat;
import hsn.optimizations.client.compat.HSNYaclCompat;
...
import hsn.optimizations.client.optimize.GpuProbe;
import hsn.optimizations.client.optimize.IntegratedGpuGuard;
...
public final class HSNOptimizationsClient {
	...
	public static void init() {
		...
		try {
			...
			HSNOptimizations.LOGGER.debug("HSN GPU session guard: {}", t.toString());
		}
