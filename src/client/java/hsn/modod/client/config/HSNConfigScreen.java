		...
		return ConfigCategory.createBuilder()
				...
				.option(Option.<Preset>createBuilder()
						...
						.description(desc(
								...
								"Frame-rate impact: moving toward Ultra Low / Safe raises FPS. Moving toward Quality lowers FPS because more of the world stays drawn."))
				...
				.group(OptionGroup.createBuilder()
						...
						.option(toggle("Performance Mode", () -> cfg.performanceModeEnabled, v -> cfg.performanceModeEnabled = v, false,
								...
								"Also bound to F6 in-game. Use it for crowded bases, raids, or weak cooling — not as an everyday default."))
		...
		return ConfigCategory.createBuilder()
				...
				.group(OptionGroup.createBuilder()
						...
						.option(toggle("Adaptive Culling", () -> cfg.adaptiveCullingEnabled, v -> cfg.adaptiveCullingEnabled = v, true,
								"When smoothed FPS falls below the target, every distance limit is scaled down toward the minimum scale. Distances recover when FPS rises again.",
								"Recommended: on. This is the live safety net under the static sliders."))
						...
						.option(toggle("Sodium Section Occupancy", () -> cfg.sectionOccupancyCullingEnabled, v -> cfg.sectionOccupancyCullingEnabled = v, true,
								"Skips entities whose 16³ section Sodium did not visit this frame (hidden behind terrain). If Sodium is missing or the occupancy set is empty, the check fails open and nothing is hidden.",
								"Recommended: on with Sodium."))
						.build())
				.group(OptionGroup.createBuilder()
