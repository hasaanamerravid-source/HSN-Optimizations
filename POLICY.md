# Storefront checklist — HSN-Optimizations 4.1.7

## Do this on the project page

- Tick Modrinth **Contains AI-generated content**.
  Approximate split: large share of Java mixins/UI drafted with an assistant;
  Rust hotpath drafted with an assistant then benchmarked; selected ASM kernels,
  mixin plugin, and config sanitize path were heavily rewritten by hand.
  Do not tick the AI box and then claim the opposite in the description.
...
- File: `hsn-optimizations-4.1.7.jar` only.
